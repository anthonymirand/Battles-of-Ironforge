...
struct  GUILayoutEntry_t5_222  : public Object_t
{
	...
	GUIStyle_t5_221 * ___m_Style_7;
};
struct GUILayoutEntry_t5_222_StaticFields{
	// UnityEngine.Rect UnityEngine.GUILayoutEntry::kDummyRect
	Rect_t5_37  ___kDummyRect_8;
